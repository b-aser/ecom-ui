            ...
            <div className="flex flex-col gap-6">
              {cartItems.map((item) => (
                ...
                >
                  ...
                  {/* Delete Button */}
                  <button className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-500 flex items-center justify-center cursor-pointer">
